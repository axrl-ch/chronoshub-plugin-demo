...
onMounted(() => {
  ...
  const stored = localStorage.getItem('_auth_return_url')

  // Detect nuxt-studio post-auth callback URL and redirect back automatically
  if (window.location.pathname.startsWith('/__nuxt_studio/auth/')) {
